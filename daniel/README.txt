There are 9 different files that need to printed. 7 are printed doudbled sided on Letter sized paper, which are designed to be horizontally symmetrical. 2 are board files that are printed single sided on larger than standard paper. I recommend using a thick cardstock for everything, especially the cards so they are not transparent.

Print 2 copies of the coins.pdf file, double-sided with itself on the back, on Letter sized paper.
...
Print 3 copies of the pawns.pdf file, double-sided with itself on the back, on Letter sized paper.
